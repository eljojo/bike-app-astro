...
export default defineConfig({
  ...
  webServer: {
    command: `CONTENT_DIR="${FIXTURE_DIR}" npx astro build && CONTENT_DIR="${FIXTURE_DIR}" LOCAL_DB_PATH="${DB_PATH}" LOCAL_UPLOADS_DIR="${UPLOADS_DIR}" npx astro preview --port 4324`,
    port: 4324,
    cwd: '..',
