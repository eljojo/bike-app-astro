...
describe('auth role checks', () => {
  const admin: SessionUser = { id: '1', email: 'a@b.com', username: 'admin', role: 'admin', bannedAt: null };
  const editor: SessionUser = { id: '2', email: 'e@b.com', username: 'editor', role: 'editor', bannedAt: null };
