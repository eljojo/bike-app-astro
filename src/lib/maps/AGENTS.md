...
| `map-paths.ts` | Shared thumbnail helpers (no virtual module imports): `mapThumbPaths()`, `variantKeyFromGpx()`, `buildStaticMapUrl()`, `buildStaticMapUrlMulti()`. Used by both Astro app and generation scripts |
