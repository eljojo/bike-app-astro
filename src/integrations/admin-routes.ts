...
{ pattern: '/auth/verify', entrypoint: view('auth/verify.astro') },
  ...
  { pattern: '/admin/stats/route/*', entrypoint: view('admin/stats-route-detail.astro') },
  { pattern: '/admin/stats/event/*', entrypoint: view('admin/stats-event-detail.astro') },
  { pattern: '/admin/stats/community/*', entrypoint: view('admin/stats-community-detail.astro') },
  ...
  { pattern: '/api/admin/stats/route/*', entrypoint: view('api/admin-stats-route.ts') },
  { pattern: '/api/admin/stats/event/*', entrypoint: view('api/admin-stats-event.ts') },
  { pattern: '/api/admin/stats/community/*', entrypoint: view('api/admin-stats-community.ts') },
