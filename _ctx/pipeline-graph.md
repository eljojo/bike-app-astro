...
| decompose.longDistance | finalize.resolve | {entries, slugMap, superNetworks} |
| finalize.write | decompose.longDistance | {entries, slugMap} |
...
graph TD
  ...
  decompose_longDistance["decompose.longDistance"]
  ...
  finalize_resolve -->|"{entries, slugMap}"| decompose_longDistance
  decompose_longDistance -->|"{entries, slugMap, superNetworks}"| finalize_write
```
